...
ADMIN_USERNAME = 'RAJPUTDDOS'  # Replace with your admin's Telegram username (without @)

# Customizable messages
OWNER_NAME = '@RAJPUTDDOS'  # Change this to the owner's name
WELCOME_MESSAGE = (
    f"🤗 𝐖𝐄𝐋𝐂𝐎𝐌𝐄 𝐓𝐎 𝐓𝐇𝐄 𝐀𝐓𝐓𝐀𝐂𝐊 𝐁𝐎𝐓⚡\n\n"
    f"𝐎𝐖𝐍𝐄𝐑 💯 {OWNER_NAME} 🔥\n\n"
    "🌏 𝐖𝐄'𝐑𝐄 𝐏𝐑𝐎𝐕𝐈𝐃𝐈𝐍𝐆 𝐀𝐑𝐄 𝐖𝐎𝐑𝐋𝐃 𝐁𝐄𝐒𝐓 𝐇𝐀𝐂𝐊𝐒 🌏\n"
    f"𝗣𝗔𝗜𝗗 𝗗𝗗𝗢𝗦 𝗔𝗩𝗔𝗜𝗟𝗔𝗕𝗘 𝗖𝗢𝗡𝗧𝗔𝗖𝗧 - @RAJPUTDDOS ⭐\n"
    f"𝘿𝙊𝙉'𝙏 𝙁𝙊𝙍𝙂𝙊𝙏 𝙏𝙊 𝙅𝙊𝙄𝙉 𝙊𝙐𝙍 𝘾𝙃𝘼𝙉𝙉𝙀𝙇 💦 @DDOSONLY123\n"
)
...
async def start(update: Update, context: CallbackContext):
    ...
    if not await is_user_allowed(user_id):
        await context.bot.send_message(
            chat_id=chat_id, 
            text="*🚫 Who goes there?* 🛑\n\n*This is a restricted area! Only authorized warriors may pass.* 💥\n*You need to be granted permission first! ⚔️* 𝗚𝗔𝗥𝗘𝗘𝗕 𝗕𝗨𝗬 𝗞𝗔𝗥 𝗙𝗥𝗘𝗘 𝗠𝗘 𝗞𝗨𝗖𝗛 𝗡𝗔𝗛𝗜 𝗠𝗜𝗟𝗧𝗔 𝗖𝗢𝗡𝗧𝗔𝗖𝗧 @RAJPUTDDOS",
            parse_mode='Markdown'
        )
        return
...
async def add_user(update: Update, context: CallbackContext):
    ...
    if user_id != ADMIN_USER_ID:
        await context.bot.send_message(
            chat_id=update.effective_chat.id, 
            text="*💀 𝗔𝗕𝗘 𝗡𝗢𝗢𝗕 𝗢𝗪𝗡𝗘𝗥 𝗛𝗜 𝗔𝗗𝗗 𝗞𝗔𝗥 𝗦𝗔𝗞𝗧𝗔 𝗛𝗔𝗜🤬 ⚡ 𝙎𝘾𝙍𝙄𝙋𝙏 𝙆𝙃𝘼𝙍𝙄𝘿 𝘼𝙐𝙍 𝙆𝙃𝙐𝘿 𝙆𝘼 𝘽𝙊𝙏 𝘽𝘼𝙉𝘼 𝙉𝘼𝙃𝙄 𝙏𝙊𝙃 𝘽𝙃𝘼𝙂 𝙅𝘼 🇧 🇺 🇾 ~ @RAJPUTDDOS 𝙋𝙍𝙄𝘾𝙀 - 200000000 𝘼𝘽 𝙉𝙄𝙆𝘼𝙇",
            parse_mode='Markdown'
        )
        return
...
async def run_attack(chat_id, ip, port, duration, context):
    try:
        ...
        await context.bot.send_message(
            chat_id=chat_id, 
            text="*⚔ 𝙈𝙄𝙎𝙎𝙄𝙊𝙉 𝘼𝘾𝘾𝙊𝙈𝙋𝙇𝙄𝙎𝙃𝙀𝘿.... ⚔\n\n⏰\n\n𝙊𝙥𝙚𝙧𝙖𝙩𝙞𝙤𝙣 𝘾𝙤𝙢𝙥𝙡𝙚𝙩𝙚.🌟\n\n𝘿𝙀𝘼𝙍 𝙐𝙎𝙀𝙍𝙎 𝙒𝙀 𝙑𝘼𝙇𝙐𝙀 𝙊𝙁 𝙔𝙊𝙐𝙍 𝙁𝙀𝙀𝘿𝘽𝘼𝘾𝙆 𝙎𝙊𝙊 𝙋𝙇𝙀𝘼𝙎𝙀 𝙎𝙀𝙉𝘿 𝙁𝙀𝙀𝘿𝘽𝘼𝘾𝙆𝙎 ✅ 𝙄𝙉 𝘾𝙃𝘼𝙏 🇯 🇴 🇮 🇳  🇨 🇭 🇦 🇳 🇳 🇪 🇱  @DDOSONLY123☺️*",
            parse_mode='Markdown'
        )
